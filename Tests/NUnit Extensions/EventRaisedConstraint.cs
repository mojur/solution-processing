...
{
    public delegate void SubscriptionCallback<TEventArg>(Action<TEventArg> assertion);
    ...
    public class EventRaisedConstraint : BaseEventRaisedConstraint<SubscriptionCallback, Action>
    {
        ...
        /// <inheritdoc />
        protected override Action GetAssertion() => () => this.eventWasRaised = true;
    }

    public class EventRaisedConstraint<TEventArg>
        : BaseEventRaisedConstraint<SubscriptionCallback<TEventArg>, Action<TEventArg>>
    {
        public delegate TSelected ArgSelector<TSelected>(TEventArg arg);
            ...
            IResolveConstraint expression)
        {
            ...
            this.applyArgConstraint = arg => constraint.ApplyTo(selector(arg));//expression.Resolve().ApplyTo(selector);
